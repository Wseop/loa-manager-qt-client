...
{
    QLabel* pNameLabel = WidgetManager::createLabel(m_pAbilityStone->getName(), LABEL_WIDTH, LABEL_HEIGHT, 10, this);
    ...
    {
        QString labelText = QString("[%1] +%2").arg(iter.key()).arg(iter.value());
        QLabel* pPenaltyLabel = WidgetManager::createLabel(labelText, LABEL_WIDTH, LABEL_HEIGHT, 10, this);
