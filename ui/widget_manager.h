...
public:
    ...
    static QLabel *createLabel(QString text, int fontSize = 10, int maxWidth = QWIDGETSIZE_MAX, int maxHeight = 25);
    ...
    static QComboBox *createComboBox(QStringList items, int fontSize = 10, int maxWidth = QWIDGETSIZE_MAX, int maxHeight = 25);
    static QLineEdit *createLineEdit(class QValidator *pValidator, QString placeHolder = "", int fontSize = 10, int maxWidth = QWIDGETSIZE_MAX, int maxHeight = 25);
